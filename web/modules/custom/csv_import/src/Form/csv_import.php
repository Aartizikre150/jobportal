...
use Drupal\csv_import\Controller\csv_importController;
 ...
 */
class csv_import extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $contentTypes = csv_importController::getAllContentTypes();
    $form['csv_import_contenttype'] = [
      '#type' => 'select',
    ...
    $form['loglink'] = [
      ...
      '#url' => Url::fromUri('base:sites/default/files/csv_importlog.txt'),
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($form_values['csv_import_contenttype'] == 'none' || $form_values['csv_import_importtype'] == 0) {
      $form_state->setErrorByName('csv_import_contenttype', $this->t('Content type or Import type missing. Please select.'));
    }
    else {
   ...
   */
  public function csv_importcallback(array &$form, FormStateInterface $form_state) {
    global $base_url;
    $ajax_response = new AjaxResponse();
    $content_type = $form_state->getValue('csv_import_contenttype');
    $import_type = $form_state->getValue('csv_import_importtype');
